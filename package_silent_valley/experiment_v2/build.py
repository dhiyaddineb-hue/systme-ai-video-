...
texts=["رغم العاصفة، دخل الرجل الوادي حاملاً فأسه وبقايا حلم قديم. كل خطوة كانت تختبر قدرته على البقاء.","بين كثيبين من الثلج، وجد كوخاً نصف مدفون. وضع يده على بابه المتجمد، فشعر بنبض خافت تحت الخشب.","وفي الليل، اشتعلت نار صغيرة. لم تعد الغابة صامتة، لأن داخل الكوخ صار هناك قلب ينبض."]
files=[os.path.join(PKG,'vo',f'v0{i}.mp3') for i in range(1,4)]
panels=[os.path.join(PKG,'panels',f'shot0{i}.jpg') for i in range(1,4)]
...
out=os.path.join(PKG,'silent_valley_experiment_v2.mp4')
