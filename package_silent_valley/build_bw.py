...
for i,u in enumerate(units):
 p=os.path.join(PKG,'panels_bw',u['panel']+'.jpg'); assert os.path.exists(p),p
 film[u['panel']]=extract_film_subs(ff,p,os.path.join(PKG,'filmshots_bw'),u['panel'])
...
out=os.path.join(PKG,'silent_valley_ep1_bw.mp4')
